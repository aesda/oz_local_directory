...
function EditJob() {
    ...
    return(
        ...
        <form onSubmit={handleSubmit(onSubmit)}  className="bg-white p-4 rounded flex flex-col gap-3">
            ...
            <input type='submit' value="Update" className=" mt-8 w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      />
